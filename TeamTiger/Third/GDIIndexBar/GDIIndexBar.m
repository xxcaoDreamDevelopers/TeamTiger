...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i = 0; i < indexCount; i++) {
        ...
        [text drawInRect:CGRectMake(shadowPoint.x, shadowPoint.y, textSize.width, _lineHeight) withAttributes:@{NSFontAttributeName:self.textFont,NSShadowAttributeName:shadow}];
        
        // draw normal color
        [self.textColor set];
        [text drawInRect:CGRectMake(point.x, point.y, textSize.width, _lineHeight) withAttributes:@{NSFontAttributeName:self.textFont,NSForegroundColorAttributeName:self.textColor}];
