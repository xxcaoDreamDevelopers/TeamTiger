...
static const CGFloat kFirstCardScale  = 1.00f;
static const CGFloat kSecondCardScale = 1.00f;

static const CGFloat kCardEdage = 5.0f;
static const CGFloat kContainerEdage = -10.0f;
static const CGFloat kNavigationHeight = 64.0f;
static const CGFloat kVisibleCount = 5;
