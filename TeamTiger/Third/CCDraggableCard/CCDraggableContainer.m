...
//    NSLog(@"gesture.view.center.x : %f,  self.cardCenter.x : %f, (gesture.view.center.x - self.cardCenter.x) / self.cardCenter.x : %f",gesture.view.center.x, self.cardCenter.x,(gesture.view.center.x - self.cardCenter.x) / self.cardCenter.x);
...
- (void)originalLayout {
    ...
    for (int i = 0; i < self.currentCards.count; i++) {
        ...
        frame.origin.y = frame.origin.y - kCardEdage * i * 0.5;
        frame.origin.x = frame.origin.x - kCardEdage * i * 2;
...
//                frame.origin.x = frame.origin.x - kCardEdage;
//                cardView.frame = frame;
//                cardView.transform = CGAffineTransformScale(CGAffineTransformIdentity, kSecondCardScale, kSecondCardScale);
//                cardView.transform = CGAffineTransformRotate(CGAffineTransformIdentity, -0.5 * (M_PI_2 / 8));
//                cardView.alpha = 0.8;
//            }
//                break;
//            case 2:
...
//                frame.origin.x = frame.origin.x - kCardEdage * 2;
//                cardView.frame = frame;
//                
//                cardView.transform = CGAffineTransformRotate(CGAffineTransformIdentity, -1.0 * (M_PI_2 / 8));
//                cardView.alpha = 0.5;
